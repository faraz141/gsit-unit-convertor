...
const UnitConvertor = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-black dark:bg-gray-900 opacity-80">
      <div
        className="max-w-md mx-auto w-full p-6 bg-card rounded-lg shadow-lg"
        style={{
          background: `linear-gradient(rgba(255, 255, 255, 0.3), rgba(255, 255, 255, 0.3)),url("https://img.freepik.com/premium-psd/modern-abstract-background-psd-holographic-colors-horizontal-desktop-wallpaper-4k-panoramic_691560-49.jpg?w=900  ")`,
        }}
      >
        <h1 className="text-2xl font-bold text-center mb-1">Unit Convertor</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Select onValueChange={handleInputUnitChange}>
              <SelectTrigger className="rounded-2xl border-black">
          ...
          <Button
            type="button"
            className="col-span-2 bg-primary rounded-2xl   text-primary-foreground hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
